...
Флаг -benchmem предоставляет информацию о выделении памяти:
B/op: количество байтов, выделяемых на каждой итерации
allocs/op: количество выделений памяти на каждой итерации
*/
